...
graph LR
  ...
  H{Початок} --> L(Шаблон)
  L ---> B({Хедер})
  L ---> A((Головна сторінка))
  L ---> C(Футер)
  B --> BA[Меню]
  A --> AA[Розділ 1. Про нас]
  BA -->
  A --> AB[Розділ 2.  Послуги]
  BA -->
  A --> AC[Розділ 3. Переваги]
  BA -->
  A --> AD[Розділ 4. Відгуки]
  BA -->
  A --> AE[Розділ 5. FAQ]
  BA -->
  A --> AF[Розділ 6. Галерея]
  BA -->
...
- **Mermaid**: Бібліотека для створення діаграм та схем в Markdown-стилі.
